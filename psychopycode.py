...
path_train_video="/Users/lscpuser/Documents/ALSE/pilot5/new/"
path_test_audio="/Users/lscpuser/Documents/ALSE/pilot5/test_sample/"

#+ str(group) + "/"


video="/Users/lscpuser/Documents/ALSE/pilot5/new/A_Disrupter0_noun0_Singularnoun_verb1_ProgressiveY_Singularverb_Disrupter0_2.mov"

win = visual.Window(fullscr="TRUE", mon ='SonyG500')
...
#   if y <2:
    ...
    videoname=str(video).replace("/Users/lscpuser/Documents/ALSE/pilot4/esc/", "").replace(".mov","")
    print(videoname)
    key = get_keypress()
    stoporcontinue(key)
    fixation.draw()
